...
public class AttendenceListAdapter extends RecyclerView.Adapter<AttendenceListAdapter.ViewHolder> {
    ...
    Context context;
    View v;
    ArrayList<HashMap<String, String>> hmstdAttendArrList;

    public AttendenceListAdapter(Context context, ArrayList<HashMap<String, String>> hmstdAttendArrList) {
        this.context = context;
        this.hmstdAttendArrList = hmstdAttendArrList;
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        final String AttClass = hmstdAttendArrList.get(position).get("stdDiv");
    ...
    public int getItemCount() {
        return hmstdAttendArrList.size();
    }
