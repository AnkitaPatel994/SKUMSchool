package com.intelliworkz.skumschool.Admin.AdminEmotional_Evaluation;
...
public class AdminEmotional_EvaluationActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_admin_emotional__evaluation);
        ...
        MenuItem menuItem = menu.getItem(10);
